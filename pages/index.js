    ...
    <div ref={containerRef} style={{
      ...
      {trailPositions.map((pos, idx) => (
        <div
          ...
          style={{
            ...
            opacity: Math.max(0, 0.8 - idx * 0.04),
            boxShadow: `0 0 ${10 - idx * 0.5}px rgba(57, 255, 20, ${0.5 - idx * 0.02})`,
            filter: `blur(${idx * 0.2}px)`,
          }}
        />
      ))}
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', alignItems: 'center' }}>
            ...
            <div>
              ...
              <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', animation: 'slideUp 0.8s ease-out 0.4s both', opacity: 0 }}>
                <MagneticButton href="#projects" mousePos={mousePos} isPrimary={true}>
          ...
          <div style={{
            ...
            <div>
              ...
              <p style={{
                ...
                I'm a creative developer working at the intersection of engineering, design, and motion. I'm interested in how systems feel — not just how they function — and how small details can turn software into an experience.
              </p>
              <p style={{
                color: '#a0afd9',
                fontSize: '1.05rem',
                ...
                My work blends performance-driven architecture with expressive interfaces. I focus on clarity, responsiveness, and motion as a form of communication, using modern web technologies to build products that feel deliberate, intuitive, and alive.
              </p>
              <p style={{
                color: '#a0afd9',
                fontSize: '1.05rem',
                ...
                I see the web as a living medium — something to be explored, not just consumed. Whether I'm building a game, a product, or an experimental interface, my goal is to create work that rewards curiosity, respects attention, and leaves a lasting impression.
              </p>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  {Object.entries(techStackDetails).map(([tech, level], i) => (
                    <InteractiveTechTag key={tech} tech={tech} level={level} delay={i * 0.05} />
                  ))}
                </div>
              </div>
            </div>

            {/* Right: Shader Canvas Placeholder */}
            <div style={{
              position: 'relative',
              height: '500px',
              display: 'flex',
      ...
      <section style={{
        ...
        <div style={{ maxWidth: '900px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap', animation: 'slideUp 0.8s ease-out 0.3s both', opacity: 0 }}>
            <a
...
function ProjectCard({ project, idx, cardTilt, hoveredProject, projectImages, isFeatured }) {
  const [imageDominant, setImageDominant] = useState(null)
      ...
      >
        ...
        >
          <img
            ...
            onLoad={(e) => {
              // Detect if image is dark or light for adaptive text
              // Simplified: assume dark for now
              setImageDominant('dark')
            }}
          />
          {/* Sheen Effect */}
          {hoveredProject === idx && (
        ...
        <div
          style={{
            position: 'absolute',
            inset: 0,
            background: hoveredProject === idx ? 'rgba(5, 7, 17, 0.3)' : 'rgba(5, 7, 17, 0.5)',
            backdropFilter: hoveredProject === idx ? 'blur(4px)' : 'blur(0px)',
            transition: 'all 0.4s',
          }}
        />
        ...
        <div
          style={{
            ...
            right: 0,
            padding: '2rem',
            background: 'linear-gradient(to top, rgba(5, 7, 17, 0.95), rgba(5, 7, 17, 0.6))',
            display: 'flex',
...
function InteractiveTechTag({ tech, level, delay }) {
...
function MagneticButton({ href, children, mousePos, isPrimary }) {
  ...
  const handleMouseMove = (e) => {
    ...
    if (distance < pullRadius) {
      ...
      setButtonPos({
        x: Math.cos(angle) * pull * 25,
        y: Math.sin(angle) * pull * 25,
      })
    } else {
  ...
  return (
    <a
      ...
      style={{
        padding: '16px 40px',
        background: isPrimary ? 'linear-gradient(135deg, #39ff14 0%, #00ffff 100%)' : 'transparent',
        ...
        alignItems: 'center',
        gap: '0.5rem',
        boxShadow: isPrimary ? '0 20px 60px rgba(57, 255, 20, 0.2)' : 'none',
